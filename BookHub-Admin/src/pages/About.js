      ...
      <section className="bg-white p-8 rounded-xl shadow-lg">
        <div className="mb-12">
          ...
          <p className="text-gray-600 leading-relaxed text-lg mb-4">
            ...
            BookHub started its journey with a simple mission: to make books accessible to everyone, everywhere. Over the years we have grown into a vibrant community of book lovers, authors, and readers who share a passion for literature.
          </p>
